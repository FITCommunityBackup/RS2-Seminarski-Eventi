...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "EventiApplication.Mobile.Android.dll" comes first in this list. */
		"EventiApplication.Mobile.Android.dll",
		"EventiApplication.Mobile.dll",
		"Flurl.dll",
		"Flurl.Http.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
