...
namespace EventiApplication.WinUI.Administratori
{
    public partial class frmNoviAdministrator : Form
    {
        ...
        private void txtPassword_Validating(object sender, CancelEventArgs e)
        {
            ...
            else if (txtPassword.Text.Length < 8 || txtPassword.Text.Length > 50)
            {
                errorProvider1.SetError(txtPassword, Properties.Resources.valErrPassword1);
                e.Cancel = true;
            }
        ...
        private async void btnSnimi_Click(object sender, EventArgs e)
        {
            if (this.ValidateChildren())
            {
                ...
                var result = await _administratorService.Insert<Administrator>(request);
        ...
        private void frmNoviAdministrator_Load(object sender, EventArgs e)
        {
            BindGradovi();
        }
